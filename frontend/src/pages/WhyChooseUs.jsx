    ...
    <section className="bg-gradient-to-b from-gray-50 to-white text-[#111] py-20 px-4 sm:px-6 lg:px-12">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-heading font-bold text-gray-900 mt-6 leading-tight">
            Why Choose <span className="text-red-600">RestroBazaar</span>
          </h2>
          <p className="mt-6 text-gray-600 text-base sm:text-lg leading-relaxed font-body">
            ...
            <ul className="space-y-5">
              {highlights.map((item, index) => (
                ...
                >
                  ...
                  <span className="text-gray-800 text-base sm:text-lg font-body pt-1 group-hover:text-gray-900 transition-colors">
                    {item}
                  </span>
                </li>
              ))}
        ...
        <div className="mt-20 text-center">
          <div className="bg-gradient-to-r from-red-50 to-gray-50 rounded-3xl p-12 border border-gray-200 shadow-lg">
            <h3 className="text-2xl sm:text-3xl lg:text-4xl font-heading font-bold text-gray-900">
              Packaging That Powers Your Food Business
            </h3>
            <p className="mt-4 text-gray-600 text-base sm:text-lg max-w-2xl mx-auto leading-relaxed font-body">
