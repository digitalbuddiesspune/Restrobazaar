          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 max-w-6xl mx-auto">
              ...
              <div className="space-y-6">
                {/* Email */}
                <div className="bg-gradient-to-br from-red-50 to-red-100/50 rounded-xl shadow-lg p-4 sm:p-5 border border-red-100 relative overflow-hidden">
                  ...
                  <div className="relative z-10">
                    <div className="flex items-start">
                      <div className="flex-shrink-0">
                        <div className="inline-flex items-center justify-center w-10 h-10 bg-gradient-to-br from-red-500 to-red-600 text-white rounded-lg shadow-lg">
                          <svg
                            className="w-5 h-5"
                            fill="none"
                            stroke="currentColor"
                      ...
                      <div className="ml-4">
                        <h3 className="text-base font-heading font-bold text-gray-900 mb-1">Email Us</h3>
                        <p className="text-xs text-gray-600 mb-2 font-body">Send us an email anytime!</p>
                        <a
                ...
                {/* Follow Us + Map - stacked vertically */}
                <div className="space-y-4">
                {/* Social Media - smaller card */}
                <div className="bg-gradient-to-br from-red-50 to-red-100/50 rounded-xl shadow-lg p-4 sm:p-5 border border-red-100 relative overflow-hidden">
                  <div className="absolute inset-0 opacity-5">
                    <div className="absolute top-0 right-0 w-32 h-32 bg-red-600 rounded-full -mr-16 -mt-16"></div>
                  </div>
                  <div className="relative z-10">
                    <h3 className="text-base font-heading font-bold text-gray-900 mb-1">Follow Us</h3>
                    <p className="text-xs text-gray-600 mb-3 font-body">Stay connected</p>
              <div className="flex flex-wrap gap-2">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-center w-10 h-10 bg-gradient-to-r from-purple-500 to-pink-500 text-white rounded-full hover:from-purple-600 hover:to-pink-600 transition-colors"
                ...
                {/* Our Location - small map beside Follow Us */}
                <div className="bg-gradient-to-br from-red-50 to-red-100/50 rounded-xl shadow-lg p-4 sm:p-5 border border-red-100 relative overflow-hidden">
                  <div className="absolute inset-0 opacity-5 pointer-events-none">
                    <div className="absolute bottom-0 left-0 w-32 h-32 bg-red-600 rounded-full -ml-16 -mb-16"></div>
                  </div>
                  <div className="relative z-10">
                    <h3 className="text-base font-heading font-bold text-gray-900 mb-1">Our Location</h3>
                    <p className="text-xs text-gray-600 mb-2 font-body line-clamp-2">Shop no 10 & 11 Bhorwasti, near Ashiana Malhar, Marunji, Pimpri-Chinchwad 411033</p>
                    <a
                      href="https://maps.app.goo.gl/bDpyVmPcHvC5Rims7"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-1.5 text-red-600 hover:text-red-700 text-xs font-semibold mb-2"
                    >
                    ...
                    <div className="rounded-lg overflow-hidden border border-gray-200 h-[180px] sm:h-[220px] lg:h-[320px]">
                      <iframe
                        title="RestroBazaar location"
                        src="https://www.google.com/maps?q=Shop+no+10+and+11+Bhorwasti,+near+Ashiana+Malhar,+Marunji+Village,+Hinjawadi,+Pimpri-Chinchwad,+Maharashtra+411033&output=embed"
                        width="100%"
                        height="100%"
