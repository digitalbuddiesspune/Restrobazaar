          ...
          <div className="mb-4">
            <div className="flex items-center justify-center gap-2">
              <div className="flex items-center gap-1">
                ...
                <span className="text-xs font-medium text-gray-700">MY BAG</span>
              </div>
              ...
              <div className="flex items-center gap-1">
                ...
                <span className={`text-xs font-medium ${showPaymentSection ? 'text-gray-700' : 'text-red-600'}`}>ADDRESS</span>
              </div>
              ...
              <div className="flex items-center gap-1">
                ...
                <span className={`text-xs font-medium ${showPaymentSection ? 'text-red-600' : 'text-gray-500'}`}>PAYMENT</span>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
            ...
            {showPaymentSection && (
              <div id="payment-section" className="lg:col-span-2 order-first">
                <div className="bg-white rounded-lg shadow-md p-4 mb-4">
                  <h2 className="text-base font-bold text-gray-900 mb-3">Select Payment Method</h2>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <div className="flex-1">
                          <div className="flex items-center gap-2">
                            ...
                            <div>
                              <h3 className="text-sm font-semibold text-gray-900">UPI Online Payment</h3>
                              <p className="text-xs text-gray-600">Pay instantly using UPI QR Code</p>
                            </div>
                          </div>
                        </div>
                      </div>
                    ...
                    {paymentMethod === 'online' && (
                      <div className="mt-3 p-4 bg-gray-50 rounded-lg border-2 border-dashed border-gray-300">
                        <div className="text-center">
                          <h3 className="text-sm font-semibold text-gray-900 mb-1">Scan QR Code to Pay</h3>
                          <p className="text-xs text-gray-600 mb-3">Use any UPI app (PhonePe, Google Pay, Paytm, etc.) to scan and pay</p>
                            ...
                            <div className="bg-white p-3 rounded-lg shadow-lg">
                              {qrCodeData ? (
                                <div className="flex flex-col items-center">
                                  ...
                                  <p className="text-xs text-gray-500 mt-1 text-center break-all max-w-xs">
                                    {qrCodeData.upiUrl}
                                  </p>
                                </div>
                              ) : (
            ...
            <div className={`lg:col-span-2 ${showPaymentSection ? 'order-last' : ''}`}>
              <div className="bg-white rounded-lg shadow-md p-4">
                <div className="flex justify-between items-center mb-3">
                  <h2 className="text-base font-bold text-gray-900">Delivery To</h2>
                  <button
                ...
                {loading ? (
                  <div className="text-center py-4">
                    ...
                    <p className="mt-2 text-xs text-gray-600">Loading addresses...</p>
                  </div>
                ) : error ? (
                  <div className="text-center py-4 text-xs text-red-600">{error}</div>
                ) : addresses.length === 0 ? (
                  <div className="text-center py-4">
                    <p className="text-xs text-gray-600 mb-3">No addresses found. Add your first address!</p>
                    <button
                      onClick={handleAddAddress}
                        ...
                        <div className="space-y-1">
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-1">
                              ...
                              <h3 className="text-sm font-semibold text-gray-900">{selectedAddressData.name}</h3>
            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-lg shadow-md p-4 sticky top-4">
                <h2 className="text-base font-bold text-gray-900 mb-3">BILLING DETAILS</h2>

                {/* Coupon Section */}
                <div className="mb-4 pb-3 border-b border-gray-200">
                  <div className="flex items-center justify-between mb-2">
                    <h3 className="text-xs font-semibold text-gray-700">Have a Coupon?</h3>
                    ...
                    <div className="mb-2 p-2 bg-gray-50 rounded-lg max-h-32 overflow-y-auto">
                      {availableCoupons.map((coupon) => (
                        ...
                        >
                          <div className="flex items-center justify-between">
                            <div>
                              <div className="font-medium text-xs text-gray-900">{coupon.code}</div>
                  ...
                  {!appliedCoupon ? (
                    <div className="flex gap-1.5">
                      <input
                        ...
                        className="flex-1 px-2 py-1.5 text-xs border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent"
                      />
                      <button
                        type="button"
                  ...
                  {couponError && (
                    <div className="mt-1 text-xs text-red-600">{couponError}</div>
                  )}
                </div>
                ...
                {!showPaymentSection ? (
                  <button
                    ...
                    className="w-full px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors font-semibold text-xs mb-3 disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    CONTINUE TO PAYMENT
                  </button>
                ) : (
                  <button
                    ...
                    className="w-full px-4 py-2 bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors font-semibold text-xs mb-3 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                  >
                    {placingOrder ? (
                      <>
                ...
                <Link
                  to="/cart"
                  className="block text-center text-gray-600 hover:text-red-600 transition-colors font-medium mt-3 text-xs"
                >
                  ← Back to Cart
                </Link>
              </div>
        ...
        <div className="bg-white rounded-lg p-4 max-w-2xl w-full max-h-[90vh] overflow-y-auto">
          ...
          <form onSubmit={handleAddressSubmit} className="space-y-2">
            ...
            <div className="flex justify-end gap-2 pt-2">
              ...
              <button
                type="submit"
                className="px-4 py-1.5 text-xs bg-red-600 text-white rounded-lg hover:bg-red-700 transition-colors font-medium"
              >
