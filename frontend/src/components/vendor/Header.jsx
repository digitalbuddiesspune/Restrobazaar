            ...
            <div className="flex-1 max-w-2xl">
              <div className="relative">
                <input
                  ...
                  className="w-full px-3 py-1.5 pl-9 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                />
                <svg
          ...
          <div className="flex items-center space-x-2 ml-3">
            ...
            <div className="flex items-center space-x-2">
              <div className="text-right hidden sm:block">
                <p className="text-xs font-semibold text-gray-900">Vendor Account</p>
