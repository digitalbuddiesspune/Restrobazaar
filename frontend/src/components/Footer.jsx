  ...
  const socialLinks = [
    {
      ...
      url: "https://www.facebook.com/restrobazaar",
    },
   
    {
      ...
      url: "https://www.instagram.com/restrobazaar",
    },
    {
      name: "LinkedIn",
      icon: (
      ...
      url: "https://www.linkedin.com/company/restrobazaar",
    },
    {
      name: "YouTube",
      icon: (
      ...
      url: "https://www.youtube.com/@restrobazaar",
    },
  ];
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-3 text-sm text-gray-400">
              ...
              <li className="flex items-start">
                ...
                <span>
                  Shop no 10 & 11 Bhorwasti, near Ashiana Malhar,<br />
                  Marunji Village, Hinjawadi, Marunji, Pimpri-Chinchwad, Maharashtra 411033
                </span>
              </li>
            </ul>
          </div>
